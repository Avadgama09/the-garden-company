...
import type { ArticleData } from '@/lib/resources';
...
export default function ArticlePageClient({
      ...
      <section className="relative py-16 md:py-24 bg-linear-to-b from-garden-sage/30 to-background">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            Back to {subtopicSlug.replace(/-/g, ' ')}
          </Link>

          <Badge variant="secondary" className="mb-4">{frontmatter.difficulty}</Badge>
  ...
  <>
    ...
    <FaqSection items={frontmatter.faqs} limit={5} />
  </>
) : (
