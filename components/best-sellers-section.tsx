...
const BEST_SELLERS: Product[] = [
  ...
  {
    id: "4",
    name: "All-Season Balcony Greens",
    slug: "all-season-balcony-greens",
    category: "Evergreen plants",
    price: 1699,
    imageUrl: "/images/demo/all-season-balcony.jpg",
  },
];

export function BestSellersClient() {
  const products = BEST_SELLERS;
        ...
        <div className="mb-8 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-emerald-900/70 md:text-base">
              Curated from balconies, terraces, and living rooms across the city.
            </p>
          </div>
              ...
              <Link href={`/shop/${product.slug}`}>
                ...
                <CardContent className="space-y-2 px-3 pb-3 pt-3">
                  ...
                  <p className="text-[11px] text-emerald-900/70">
                    Designed for Mumbai weather with support from our Garden Coach.
                  </p>
                </CardContent>
              </Link>
            </Card>
